...
public abstract class Animal implements AnimalInfo, Entity {
	...
	protected Animal(Animal p1, Animal p2) {
		...
		this.sightRange = Utils.getRandomizedParameter((p1.sightRange+p2.getSightRange())/2, 0.2);
		this.pos = p1.getPosition().plus(Vector2D.getRandomVector(-1,1).scale(60.0*
	...
	public void init(AnimalMapView regMngr) {
		...
		if(this.pos == null) {
			pos = pos.getPosAleatoria(0.0, regionMngr.getWidth()-1, 0.0, regionMngr.getHeight()-1);
		} else {
			pos = pos.ajustaPosicion(regionMngr.getWidth()-1, regionMngr.getHeight()-1);
		}
		this.dest =  getPosAleatoria(0.0, regionMngr.getWidth()-1, 0.0, regionMngr.getHeight()-1);
	}
